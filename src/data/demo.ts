...
{id:'horizonte',name:'Fundación Horizonte',description:'Organización dedicada a proyectos educativos y comunitarios.',email:'contacto@horizonte.org',location:'Buenos Aires',type:'organization'},
{id:'universidad',name:'Universidad Nacional',description:'Institución académica.',email:'info@universidad.edu',location:'Córdoba',type:'organization'},
{id:'innovar',name:'Empresa Innovar',description:'Empresa dedicada al desarrollo de herramientas digitales.',email:'hola@innovar.com',location:'Buenos Aires',type:'organization'},
{id:'comunidades',name:'Red Comunidades',description:'Red de organizaciones y referentes territoriales.',email:'red@comunidades.org',location:'Rosario',type:'organization'},
{id:'educacion',name:'Educación Digital 2026',description:'Programa de innovación y transformación educativa.',type:'project'},
{id:'redinnovacion',name:'Red de Innovación',description:'Iniciativa para conectar organizaciones y referentes.',type:'project'},
{id:'programa',name:'Programa Comunidades',description:'Programa de articulación entre organizaciones territoriales.',type:'project'}];
